...
Lit projets/rag/ch2-socle-technique/narration.json → projets/rag/ch2-socle-technique/audio/stop-<id>.mp3
...
BASE = os.path.expanduser("~/Desktop/ragtycoon/projets/rag/ch2-socle-technique")
